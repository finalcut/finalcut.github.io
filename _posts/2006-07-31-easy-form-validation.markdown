...
Sadly, I just haven't had time to expand on this the way Thomas asked me to
before.

Anonymous

I've moved to doing crud and validation directly through reactor. This was a
great start to understanding how some of it works in the background. Thanks.

Thomas

Great!  
  
I'm also interested in how you move the logic in the index.cfm file into a CFC
or a Fuseaction. I noticed you had an XFA in there for password changes...

Bill

Tom,  
  
I will try and get something up that is a little more flushed out by the end
of the weekend. I'll just extend the example I provided earlier so that,
...
Thanks for putting this out there, It's really helped me to better understand
CFCs, Beans, and some concepts I've been struggling with.  
  
I'm a little stuck again...  
  
Could post a more complete example of how you indicate that a particular field
is invalid once the form is submitted? Can each input have a custom message if
it was filled in wrong? Or, do you simply indicate which fields were invalid?
How?  
  
How about the class attribute you're using in the input fields? For
instance... Do you simply change the border color of required fields?
Something more fancy?  
  
Anything that would help me get a more complete picture of the entire process.  
